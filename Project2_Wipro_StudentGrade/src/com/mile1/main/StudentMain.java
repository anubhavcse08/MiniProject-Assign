...
public class StudentMain {
	static Student data[] = new Student[13];
	static{
		...
		data [2] = null;
		data [3] = null;
		data [4] = new Student("Manoj", null);
		data [5] = new Student ("A1", new int [ ] {72, 73, 74});
		data [6] = new Student ("B1", new int [ ] {75, 76, 77});
		data [7] = new Student ("C1", new int[ ] {99, 99, 99});
		data [8] = new Student ("C3", new int[ ] {100, 100, 99});
		data [9] = new Student ("B2", new int[ ] {13, 88, 13});
		data [10] = new Student ("C3", new int[ ] {14, 14, 99});
		data [11] = new Student ("A2", new int[ ] {77, 55, 12});
		data [12] = new Student ("A5", new int[ ] {13, 88, 13});
		}
